...
$id=$_REQUEST['id'];
$query = "SELECT * from apply_loans where id='".$id."'"; 
...
<input name="id" type="hidden" value="<?php echo $row['id'];?>" />
						<div class="form-group">
							<label for="name" class="cols-sm-2 control-label">Register For Loans</label>
							<div class="cols-sm-10">
								<div class="input-group">
									<span class="input-group-addon"><i class="fa fa-user fa" aria-hidden="true"></i></span>
									<input type="text" class="form-control" name="reg_loans"   placeholder="Enter your Name" required value="<?php echo $row['reg_loans'];?>"/>
								</div>
							</div>
						</div>
						...
						<div class="form-group">
							...
							<div class="cols-sm-10">
								<div class="input-group">
									<span class="input-group-addon"><i class="fa fa-user fa" aria-hidden="true"></i></span>
									<input type="text" class="form-control" name="material"   placeholder="Enter Material" required value="<?php echo $row['reg_name'];?>"/>
								</div>
							</div>
						</div>
						...
						<div class="form-group">
							...
							<div class="cols-sm-10">
								<div class="input-group">
									<span class="input-group-addon"><i class="fa fa-user fa" aria-hidden="true"></i></span>
									<input type="text" class="form-control" name="bags"   placeholder="no of bags" required value="<?php echo $row['reg_email'];?>"/>
								</div>
							</div>
						</div>
						...
						<div class="form-group">
							...
							<div class="cols-sm-10">
								<div class="input-group">
									<span class="input-group-addon"><i class="fa fa-user fa" aria-hidden="true"></i></span>
									<input type="text" class="form-control" name="vehicle"   placeholder="vehicle no" required value="<?php echo $row['reg_phone'];?>"/>
								</div>
							</div>
						</div>
						...
						<div class="form-group">
							...
							<div class="cols-sm-10">
								<div class="input-group">
									<span class="input-group-addon"><i class="fa fa-user fa" aria-hidden="true"></i></span>
									<input type="text" class="form-control" name="rate"   placeholder="rate" required value="<?php echo $row['reg_company'];?>"/>
								</div>
							</div>
						</div>
						<div class="form-group">
							...
							<div class="cols-sm-10">
								<div class="input-group">
									<span class="input-group-addon"><i class="fa fa-user fa" aria-hidden="true"></i></span>
									<input type="text" class="form-control" name="payment"   placeholder="rate" required value="<?php echo $row['reg_city'];?>"/>
								</div>
							</div>
						</div>
