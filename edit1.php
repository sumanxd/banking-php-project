...
reg_loans='".$reg_loans."', reg_name='".$reg_name."', reg_email='".$reg_email."', reg_phone='".$reg_phone."', reg_company='".$reg_company."' where id='".$id."'";
...
<input name="id" type="hidden" value="<?php echo $row['id'];?>" />
						<div class="form-group">
							...
							<div class="cols-sm-10">
								...
								<select class="form-control" name="reg_loans" required value="<?php echo $row['reg_loans'];?>">
								<option>Personal Loans</option>
								<option>car loans</option>
								<option>home loans</option>
								<option>used car loans</option>
								<option>mortgaze loans</option>
								<option>LAP</option>
						...
						<div class="form-group">
							...
							<div class="cols-sm-10">
								<div class="input-group">
									<span class="input-group-addon"><i class="fa fa-user fa" aria-hidden="true"></i></span>
									<input type="text" class="form-control" name="reg_phone"   placeholder="enter block" required value="<?php echo $row['reg_phone'];?>"/>
								</div>
							</div>
						</div>
						<div class="form-group">
						...
						<div class="form-group">
							<label for="name" class="cols-sm-2 control-label">Select City</label>
							<div class="cols-sm-10">
								<div class="input-group">
									<span class="input-group-addon"><i class="fa fa-user fa" aria-hidden="true"></i></span>
									
								<select class="form-control" name="reg_city" required value="<?php echo $row['reg_city'];?>">
